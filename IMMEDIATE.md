...
[ ] add test case to check that using a…b with a and b being numeric values with different units is rejected
[ ] fix the capture-as-a-read warning divergence in ngplc
