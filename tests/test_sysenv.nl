...
// exact-value tests live in tests/output/sysenv.nl, which is invoked
...
fn error_args_get_out_of_range() → ∅:
    let past_end : mut = std.args.count()
...
@start
fn main() → ∅:
    std.print("system environment tests passed")
