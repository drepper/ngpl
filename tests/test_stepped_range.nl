...
@test
fn test_step_no_overshoot -> none:
    var sum := 0
    foreach i = 0…3…10:
        sum ← sum + i
...
@test
fn test_step_single_element -> none:
    var count := 0
    foreach i = 5…10…5:
        count ← count + 1
