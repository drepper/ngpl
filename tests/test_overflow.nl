...
fn error_i8_add_overflow -> ø:
    var x : i8 = 127
    var y : i8 = 1
    var z := x + y

@expect error "integer overflow"
fn error_i8_sub_underflow -> ø:
    var x : i8 = -128
    var y : i8 = 1
    var z := x - y

@expect error "integer overflow"
fn error_i16_mul_overflow -> ø:
    var x : i16 = 200
    var y : i16 = 200
    var z := x * y

@expect error "integer overflow"
fn error_i32_add_overflow -> ø:
    var x : i32 = 2147483647
    var y : i32 = 1
    var z := x + y

@expect error "integer overflow"
fn error_i32_negate_min -> ø:
    var x : i32 = -2147483648
    var z := -x
...
@test
fn test_bitwise_not_i8 -> ø:
    var x : i8 = 0
    var y := ~x
    assert_eq(y, -1)

@test
fn test_shift_left_wraps -> ø:
    var x : u8 = 128
    var s : u8 = 1
    var y := x « s
    assert_eq(y, 0)
