...
fn test_left_fold_sum() → ∅:
    let result : mut = (λa : int, b : int → int: a + b) ⌿ [1, 2, 3, 4, 5]
    assert_eq(result, 15)
...
fn test_left_fold_with_init() → ∅:
    let result : mut = (λa : int, b : int → int: a + b) ⌿ ([1, 2, 3, 4, 5], 100)
...
fn test_right_fold_subtract() → ∅:
    ...
    let result : mut = (λa : int, b : int → int: a - b) ⍀ [1, 2, 3]
    assert_eq(result, 2)
...
fn test_right_fold_build() → ∅:
    ...
    let result : mut = (λa : int, b : int → int: a + b * 2) ⍀ ([1, 2, 3], 10)
    assert_eq(result, 97)
