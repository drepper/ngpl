...
fn test_left_fold_with_init() → ∅:
    let result := (λa : int, b : int → int: a + b) ⌿ ([1, 2, 3, 4, 5], 100)
...
fn test_right_fold_subtract() → ∅:
    ...
    let result := (λa : int, b : int → int: a - b) ⍀ [1, 2, 3]
    assert_eq(result, 2)
...
fn test_right_fold_with_init() → ∅:
    ...
    let result := (λa : int, b : int → int: a - b) ⍀ ([1, 2, 3], 5)
    assert_eq(result, ⁻3)
...
fn test_left_fold_empty_with_init() → ∅:
    let result := (λa : int, b : int → int: a + b) ⌿ ([], 42)
    assert_eq(result, 42)
...
fn test_left_fold_single() → ∅:
    let result := (λa : int, b : int → int: a + b) ⌿ [7]
    assert_eq(result, 7)
